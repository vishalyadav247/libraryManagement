...
<button id="addBookBtn" type="submit"
    class="btn btn-outline-success mt-5 mb-2 col-4 mx-auto rounded-3 border border-5 border-light fw-bold">Add
    Book</button>
    </form>`
        ...
        `
            <form id="issueBookForm">
                ...
                <button id="issueBookBtn" type="submit"
                    class="btn btn-outline-danger my-5 col-4 rounded-3 border border-5 border-light fw-bold  mx-auto">Issue
                    Book</button>
            </form>
       `
...
function operation2() {
    ...
    <button id="returnBookBtn" type="submit"
        class="btn btn-outline-success my-5 col-4 rounded-3 border border-5 border-light fw-bold  mx-auto">Return
        Book</button>
</form>
`
